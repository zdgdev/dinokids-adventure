      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <p className="text-sm text-center md:text-left">
              © {currentYear} Dino Math Adventure - Open Source Educational Games for Kids
            </p>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <a 
              href="https://github.com/username/dino-math-adventure" 
              target="_blank" 
        ...
        <div className="mt-4 flex justify-center items-center text-xs text-gray-400">
          <p className="flex items-center">
            Made with <Heart className="w-3 h-3 mx-1 text-red-500" /> for young learners everywhere
          </p>
        </div>
      </div>
    </footer>
