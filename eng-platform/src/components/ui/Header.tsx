...
const Header = () => {
  ...
  const navLinks = [
    { path: '/', label: 'Home' },
    { path: '/math-game', label: 'Math Adventure' },
    { path: '/counting-game', label: 'Counting Safari' },
    { path: '/shapes-game', label: 'Shape Explorer' },
    { path: '/parent-dashboard', label: 'Parent Zone' },
  ];
